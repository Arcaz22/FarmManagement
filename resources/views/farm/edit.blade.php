<button type="button" class="dropdown-item" href="{{ route('farm.edit', $management->id) }}" data-bs-toggle="modal" data-bs-target="#ubahKandang">Edit</button>
{{-- Edit Data --}}
            ...
            <form action="{{ route('farm.update', $management->id) }}" method="post">
                <div class="modal-body py-0">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="mb-3 form-control" id="nama_kandang" name="nama_kandang" value="{{ $management->nama_kandang }}" required>
                    </div>
                    <div class="form-group">
                        <label class="fw-bold mb-2" for="kepala_kandang">Kepala Kandang</label>
                        <input type="text" class="mb-3 form-control" id="kepala_kandang" name="kepala_kandang" value="{{ $management->kepala_kandang }}"
                            required>
                    </div>
                    <div class="form-group">
                        <label class="fw-bold mb-2" for="status_kandang">Status Kandang</label>
                        <select class="form-select mb-3" id="status_kandang" name="status_kandang" value="{{ $management->status_kandang }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="mb-3 form-control" id="kapasitas_kandang" name="kapasitas_kandang" value="{{ $management->kapasitas_kandang }}"
                            required>
                    </div>
                    <div class="form-group">
                        <label class="fw-bold mb-2" for="lokasi_kandang">Lokasi Kandang</label>
                        <textarea type="text" class="mb-3 form-control" id="lokasi_kandang" name="lokasi_kandang" required>{{ $management->lokasi_kandang }}</textarea>
                    </div>
                </div>
